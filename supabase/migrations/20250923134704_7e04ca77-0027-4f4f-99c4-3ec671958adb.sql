-- Clean up any existing demo steps and recreate them properly
DELETE FROM call_steps WHERE step_id LIKE 'demo_%' OR step_id LIKE 'mms_%' OR step_id LIKE 'eon_%' OR step_id LIKE 'dhl_%' OR step_id LIKE '1und1_%';

-- Now insert the steps with proper unique IDs
