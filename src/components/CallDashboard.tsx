      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-3xl font-bold text-foreground">Call Center Agent Dashboard</h1>
              <p className="text-muted-foreground mt-1">Live-Klick-Leitfaden für Kundenanrufe</p>
            </div>
